...
| **Engenharia Reversa** | Análise de um webapp de referência e recriação da aplicação sem acesso ao código original.
Geração do app com Gemini no Google AI Studio usando HTML, CSS e JS. | [Ver Projeto](./projeto-engenharia-reversa/) |
